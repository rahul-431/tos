...
const Footer = () => {
  return (
    <div className="w-full footerBg px-4 sm:px-8 md:px-12 lg:px-20 py-12 flex sm:flex-row flex-col justify-between gap-10 text-white">
      ...
      <div className="flex flex-col gap-4 sm:items-end">
        ...
        <div className="flex gap-5 items-center">
          <Link
            href={"#"}
            className="text-2xl p-2 sm:p-4 rounded-full border-white border hover:bg-white hover:text-[#03305A]"
          >
            <FaFacebookF />
          </Link>
          <Link
